  ...
  return (
    <div className="flex items-center justify-between px-4 sm:px-8 md:px-12 py-2 sm:py-3 border-b border-slate-200 transition-all">
      ...
      >
        ...
        <p className="absolute text-[10px] sm:text-xs font-semibold -top-2 -right-10 sm:-right-12 px-2 sm:px-3 py-0.5 rounded-full flex items-center gap-1 sm:gap-2 text-white bg-green-500">
          Admin
        </p>
      </Link>
